...
import {
  LayoutDashboard, Calendar, List, Users, Wallet, Settings, Megaphone, ShieldCheck, Smartphone, Wrench, Ticket, Car, QrCode, Sparkles, CreditCard, Star, MessageSquareHeart, Headphones,
} from 'lucide-react'
