      ...
      <div className="max-w-6xl mx-auto px-4 md:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-2">by Sellem Inc.</p>
            <p className="text-sm text-gray-400 mt-1">autoon.kr</p>
          </div>
          <div>
        ...
        <p className="text-xs text-gray-400 mt-10 text-center">© 2025 Sellem Inc. All rights reserved.</p>
      </div>
    </footer>
  )
}
