...
export const ADMIN_MENU_REGISTRY: AdminMenuDef[] = [
  ...
  { key: 'business_reviews', label: '입점심사', href: '/admin/businesses/pending', group: '업체', icon: '📋', ready: true },
  {
    ...
    label: '입점·서류 심사',
    href: '/admin/businesses/compliance',
    group: '업체',
    icon: '📁',
    ready: true,
  },
  ...
  { key: 'support', label: '문의관리', href: '/admin/support/tickets', group: '고객센터', icon: '🎧', ready: true },
  { key: 'support_faqs', label: 'FAQ 관리', href: '/admin/support/faqs', group: '고객센터', icon: '❓', ready: true },
  { key: 'announcements', label: '공지사항', href: '/admin/support/notices', group: '고객센터', icon: '📢', ready: true },
